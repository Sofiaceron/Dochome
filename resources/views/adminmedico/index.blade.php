                ...
                <section class=" card container-fluid cajita2">
                    <section class=" card container-fluid cajas">
                        <article class="formato container-fluid">
                            <img class="imgRedonda" src="img/doc.jpg" alt="">
                            <h2>Fabian Sanchez</h2>
                            <h2>1061684233</h2>
                            <h2>3054385504</h2>
                            <h2>fabi@gmail.com</h2>
                            <h2>wijjksqk</h2>
                            ...
                            <button type="submit" class=" bot btn btn-warning"><i class='bx bxs-edit bx-sm'
                                    undefined></i></button>
                            <button type="submit" class=" bot btn btn-success"><i class='bx bxs-check-square bx-sm' style='color:#ffffff'  ></i></button>
